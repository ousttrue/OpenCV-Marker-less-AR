...
pushd %BUILD_DIR%
%CMAKE% -D CMAKE_INSTALL_PREFIX=%VCPKG_DIR%/installed/x64-windows -D libpng16_DIR=%VCPKG_DIR%/installed/x64-windows/share/libpng -G "Visual Studio 15 2017 Win64" ..
popd
